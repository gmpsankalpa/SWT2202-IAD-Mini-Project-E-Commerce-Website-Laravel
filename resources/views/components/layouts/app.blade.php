                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-xl-3 col-lg-4">
                        <div class="header-info header-info-right">
                            ...
                            @else
                            <ul>
                                <li><i class="fi-rs-key"></i><a href="{{asset('login')}}">Log In </a> / <a
            ...
            <div class="container">
                <div class="header-wrap header-space-between position-relative">
                    ...
                    <div class="hotline d-none d-lg-block">
                        <p><i class="fi-rs-smartphone"></i><span>Call Free</span> (+94)77-548-7110 </p>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="widget-about font-md mb-md-5 mb-lg-0">
                            ...
                            <p class="wow fadeIn animated">
                                <strong>Address: </strong>University Park, Oluvil
                            </p>
                            <p class="wow fadeIn animated">
                                <strong>Phone: </strong>(+94)77-548-7110
                            </p>
                            <p class="wow fadeIn animated">
                                <strong>Email: </strong>contact@group5.com
                            </p>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <p class="text-lg-end text-start font-sm text-muted mb-0">
                        &copy; <strong class="text-brand">Group Project 5</strong> All rights reserved
                    </p>
                </div>
            </div>
        </div>
