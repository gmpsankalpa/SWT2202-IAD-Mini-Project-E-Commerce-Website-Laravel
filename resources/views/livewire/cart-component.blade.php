                        ...
                        <div class="table-responsive">
                                        ...
                                        @foreach (Cart::instance('cart')->content() as $item)
                                            <tr>
                                                <td class="image product-thumbnail"><img
                                                        src="{{asset('assets/imgs/products')}}/{{$product->image}} "alt="{{ $item->name }}">
                                                </td>
                            ...
                            <tr>
                                <td colspan="6" class="text-end">
                                    <a href="#" class="text-muted" wire:click.prevent="clearAll()"> <i class="fi-rs-cross-small"></i> Clear
                                        Cart</a>
                                </td>
                            </tr>
                            </tbody>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="cart_total_amount"><strong><span
                                                                class="font-xl fw-900 text-brand">Free
                                                                Shipping</span></strong></td>
                                                </tr>
                                                <tr>
