                ...
                <div class="row">
                    <div class="col-lg-9">
                        <div class="shop-product-fillter">
                            ...
                            <div class="sort-by-product-area">
                                ...
                                <div class="sort-by-cover">
                                    ...
                                    <div class="sort-by-dropdown">
                                        <ul>
                                            <li><a class="{{$orderBy=='Default Sorting' ? 'active':''}}" href="#" wire:click.prevent="changeOrderBy('Default Sorting')" wire:model="orderBy">Default Sorting</a></li>
                                            <li><a class="{{$orderBy=='Price: Low to High' ? 'active':''}}" href="#"  wire:click.prevent="changeOrderBy('Price: Low to High')" wire:model="orderBy">Price: Low to High</a></li>
                                            <li><a class="{{$orderBy=='Price: High to Low' ? 'active':''}}" href="#" wire:click.prevent="changeOrderBy('Price: High to Low')" wire:model="orderBy">Price: High to Low</a></li>
                                            <li><a class="{{$orderBy=='Sort By Newness' ? 'active':''}} "href="#" wire:click.prevent="changeOrderBy('Sort By Newness')" wire:model="orderBy">Sort By Newness</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row product-grid-3">
                            ...
                            <div class="col-lg-4 col-md-4 col-6 col-sm-6" bg>
                                <div class="gayan">
